...
class Clock():
    ...
    def starttick(self,second_hand,minute_hand,hour_hand,printer):
        ...
        turtle.tracer(False)
        printer.forward(65)
        printer.write(self.getweekday(today), align = 'center', font =("digital-7",14,"bold"))
        printer.forward(120)
        printer.write('12',align = 'center',font = ("digital-7",14,"bold"))
        printer.back(250)
        printer.write(self.getdate(today), align = 'center',font = ("digital-7",14,"bold"))
        printer.back(145)
        printer.write('6',align = 'center',font = ("digital-7",14,"bold"))
        printer.home()
        printer.right(92.5)
        printer.forward(200)
        printer.write('3',align = 'center',font = ("digital-7",14,"bold"))
        printer.left(2.5)
        printer.back(400)
        printer.write('9',align = 'center',font = ("digital-7",14,"bold"))
        printer.home()
        turtle.tracer(True)
        turtle.ontimer(lambda : self.starttick(second_hand,minute_hand,hour_hand,printer))
